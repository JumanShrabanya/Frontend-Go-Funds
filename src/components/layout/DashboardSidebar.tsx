        ...
        <List disablePadding>
          <ListItem disablePadding sx={{ mb: 0.5 }}>
            <ListItemButton sx={{ borderRadius: 2, color: '#64748B', '&:hover': { bgcolor: 'rgba(15, 23, 42, 0.04)', color: '#0F172A' } }}>
              ...
              <ListItemText primary="Settings" slotProps={{ primary: { sx: { fontSize: '0.95rem', fontWeight: 500 } } }} />
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding>
            <ListItemButton onClick={logout} sx={{ borderRadius: 2, color: '#EF4444', '&:hover': { bgcolor: 'rgba(239, 68, 68, 0.08)' } }}>
              ...
              <ListItemText primary="Logout" slotProps={{ primary: { sx: { fontSize: '0.95rem', fontWeight: 500 } } }} />
            </ListItemButton>
          </ListItem>
        </List>
      </Box>
